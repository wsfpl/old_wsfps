...
<section class="main-container">
    <div class="left-menu-panel">
        ...
        <ul class="left-menu-panel-ul">
            ...
            <li><a href="<spring:url value="/rmdashboard"/>" class="menu-items-a"><i class="glyphicon glyphicon-dashboard"></i>Dashboard</a></li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card-panel mb-15">
                    <div class="inner-card-structure">
                     ...
                     <div class="view-detail"><a <%-- href="<spring:url value="/dealerList"/>" --%> class="view-page dealerPageview" data-tab="dealerlist"><i class="fa fa-eye"></i>view</a></div>
                </div>
            </div>
            <div class="clearfix"></div>
        </div>
            ...
            <div class="common-inner-padding pending-common-inner-width">
                ...
                <div class="table-wrapper o-table-wrapper">
                 ...
                 <div class="col-sm-12 p-xs640-0 p-xs320-0">
                    ...
                    <div class=" xs-responsive" id="divDlrViewCardsId">
                            ...
                            <div class="card-description-box">
                                <div class="details">
                                    <div class="dealer-p">
                                        ...
                                        <span class="dealer-value">${pendingOrderListSize}</span>
                                    </div>
                                    <div class="dealer-p">
                                ...
                                <div class="view-box">
                                    <div class="text-center">
                                         <a  type="button" class="btn btn-view-apre view-page" href="<spring:url value="/rmpendingordsdtls?dlrNo=${list.dlrNo}"/>">View</a>
                                    <div class="approve-reject-box">
				                        <button type="button"  class="btn approve-btn btn-view-apre btn-view-approve" value="${list.dlrNo}">Approve</button>
				                        <button type="button"  class="btn reject-btn btn-view-apre btn-view-reject" value="${list.dlrNo}">Reject</button>
				                    </div>
                                    </div>
        ...
        <div class="common-inner-padding orderbilling-parent">
      	...
      	<form class="o-form-filtering parent-cal">
            <div class="col-xs-4 col-sm-5 col-md-3 col-lg-3">
              ...
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 xs-w-50">
              	<button type="button" class="btn downloaexceldbtn">Download Excel*</button>
              </div>
             </div>
              <div class="clearfix"></div>
        </form>
            ...
            <div class="hiddenxs">
                ...
                <div class="">
                    <div class="table-responsive">
                                <table id="orderstatus-table" class="display table-style border-collapse-unset" style="width: 100%">
                                    <thead>
                                    	<tr>
            ...
            <div class="table-wrapper o-table-wrapper">
                ...
                <span>${Test}</span>
                    <div class="table-responsive table-responsive-code">
                           <table id="orderstatus-table-dlr" class="display dealerlist-datatable-cls table-style last-td-withoutstatus" style="width: 100%">
                                    <thead>
                                        <tr>
...
<div id="viewdetail-modal" class="modal fade view-detail-modal-style" role="dialog">
  <div class="modal-dialog modal-lg" >
    ...
    <!-- Modal content-->
     <div class="modal-content" id="modalOrderDtlsId">
      </div> 
      <!-- Modal content end-->
    </div>
...
<script src="js/tm_js/rmcustom.js"></script>
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script type="text/javascript">
$(document).ready(function(){
var roleSeq = '${roleSeq}';
if("pendingorders" == roleSeq){
