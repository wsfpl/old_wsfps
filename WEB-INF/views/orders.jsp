...
<spring:url value="/" var="contextPath" />
    ...
    <title>Orders - Seed and Dairy</title>
  ...
  <input type="hidden" 		name="${_csrf.parameterName}"		value="${_csrf.token}" />
    ...
    <div class="body-wrapper">
        ...
        <div class="content-box-wrapper">
                        ...
                        <div class="panel with-nav-tabs panel-default">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="li-width" id="completed"><a class="tab-color" data-toggle="tab" href="#menu1">Completed</a></li>
                                    <li class="li-width" id="partiallyCompleted"><a class="tab-color" data-toggle="tab" href="#menu2">Partially Completed</a></li>
                                    <li class="li-width" id="pending"><a class="tab-color" data-toggle="tab" href="#menu3">Pending</a></li>
                                    <li class="li-width" id="rejected"><a class="tab-color" data-toggle="tab" href="#menu4">Rejected</a></li>
                                </ul>
                </div>
            ...
            <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    ...
                    <div class="input-daterange input-group btn-posit" id="flight-datepicker">
                       <div class="col-sm-4">   

                            <label for="from">From</label>

                            <input type="text" id="from" class="date-picker-1" name="from">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="to" class="date-picker-1" name="to">

                        </div>

 
                        <div class="col-sm-4">
                            <button type="button" class="btn btn-success" id="tofromsubmit">Submit</button>
                        </div> 
                    </div>
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered" id="orderTable">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>Customer Code</th>
                                    ...
                                    <!--     <tr>
                                            ...
                                            <td>A23456</td>
                                            <td>Product 1</td>
                                            <td>kjsdbksjdbvksbdvksdb jashcjahsc</td>
                                            <td>Approved</td>
      ...
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Completed</p>
                    ...
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered" id="completedTable">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>Customer Code</th>
    ...
    <div id="menu2" class="tab-pane fade">
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Partially Completed</p>
                        <!-- <button class="create-btn"><i class="fa fa-plus trans-4ms"></i> &nbsp;Add user</button> -->
                        <div class="clearfix"></div>
                    </div>
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered " id="partiallyCompTable">
                                    <thead>
                                        <tr>
                                          <th>Sr. No</th>
                                            <th>Customer Code</th>
    ...
    <div id="menu3" class="tab-pane fade">
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Pending</p>
                        <!-- <button class="create-btn"><i class="fa fa-plus trans-4ms"></i> &nbsp;Add user</button> -->
                        <div class="clearfix"></div>
                    </div>
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered " id="pendingTable">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>Customer Code</th>
    ...
    <div id="menu4" class="tab-pane fade">
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Rejected</p>
                        <!-- <button class="create-btn"><i class="fa fa-plus trans-4ms"></i> &nbsp;Add user</button> -->
                        <div class="clearfix"></div>
                    </div>
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered " id="rejectedTable">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>Customer Code</th>
    ...
    <script type='text/javascript' src="${contextPath}js/orders.js"></script>
