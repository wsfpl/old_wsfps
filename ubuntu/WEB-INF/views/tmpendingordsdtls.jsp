...
<html lang="en">
<%System.out.println("inside tmpending orderdetail.jsp");%>
<head>
     ...
     <div class="wrapper-orders">
        <div class="card-text">Orders Details</div>
             <ol class="breadcrumb text-black mb-0 pull-right">
                 <li><a href="<spring:url value="/tmdashboard"/>" class="menu-items-a"><i class="glyphicon "></i>Dashboard</a></li>
               <li><a class ="abcded menu-items-a pendingorders-redirectlink" href="<spring:url value="/tmpendingorder"/>" >Pending Orders</a></li>
          ...
          <div class="common-inner-padding">
           <div class="order-top-detail">
            <div class="dealer-top-detail">
                <p class="dealer-p"><span class="dealer-p-span"><b class="b_title">Dealer:</b></span><span class="dealer-p-namevalue-span">${dlr.name}/${dlr.userId}</span></p>
            </div>
...
<script src="js/tm_js/tmpendingordsdtls.js"></script>
