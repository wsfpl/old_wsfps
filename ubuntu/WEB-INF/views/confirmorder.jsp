...
<script type="text/javascript">
	...
	var cback = "confirmOrders()";
	
	// 	http://MMKNDSLP1.corp.mahindra.com:8000/sap/opu/odata/sap/ZGW_DAIRY_SRV/Stg_HeaderSet?$expand=NavStaging&$filter=Kunnr eq 'FDM1001' and ( Flag eq 'R' or Flag eq 'B' )
	/* var url = "http://qaapps.mahindra.com/sap/opu/odata/sap/ZGW_DAIRY_SRV/Stg_HeaderSet?$expand=NavStaging&$filter=Kunnr eq '"
			+ kunnr + "' and (Flag eq 'C' or Flag eq 'B' or Flag eq 'X' )"; */
...
<body class="bodyBg" onload="setUserName()">
	...
	<div class="container">
		<div class="ulDiv col-md-6 col-md-offset-3">
			...
			<div class="mainCont">
				<h2>
					<span><img src="images/smconfirmorderico.png">Confirmed
						Orders</span>
				</h2>
				<div class="ulDiv">
					<ul id="confirmOrder" class="confirmorderul">
