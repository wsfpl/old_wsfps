                    ...
                    <div class="data-table-box">
                        <div>
                            <div class="table-responsive">
                                <table class="table table-stripped table-bordered dealerTMRMtable" id="dealerTMRMtable">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>Dealer Name</th>
                                    ...
                                    <tbody>
                                    <c:forEach var="details" items="${dealerTMRM}" varStatus="status">
                                        <tr>
                                            <td><c:out value="${status.index+1}"></c:out></td>
                                            <td><c:out value="${details.dealerName}"></c:out></td>
                                            <td><c:out value="${details.TMName}"></c:out></td>
                                            <td><c:out value="${details.RMName}"></c:out></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="userrole" name="userrole" required="required">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                           ...
                           <%--  <c:if test="${user.business_name == 'Dairy'}">
                              <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="region">User Business :</label>
                                    <input type="text" class="form-control"  id="edit_business" name="business" value="Dairy">
                                </div>
                            </div>
                            </c:if> --%>
                           <%--  <c:if test="${user.business_name == 'Seeds'}"> --%>
