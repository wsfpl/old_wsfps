...
<spring:url value="/" var="contextPath" />
    ...
    <title>Sync - Seed and Dairy</title>
...
<spring:url value="/" var="contextPath" />
            ...
            <div class="top-head">
                <div class="top-innner-head">
                    ...
                    <div class="profile-logout-box">
                        <div class="profile-box"><a href=""><i class="fa fa-user"></i><!--<img src="" class="img-responsive" / >-->
    ...
    <li class="active"><a data-toggle="tab" href="#home">Sync Services</a></li>
      ...
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Sync Services</p>
    ...
    <div id="menu1" class="tab-pane fade">
      <div class="content-box-wrapper1">
                <div class="content-box-inner-wrapper">
                    <div class="breadcrumps-box">
                        <p class="breadcrumps-text">Product Details</p>
                        <!-- <button class="create-btn"><i class="fa fa-plus trans-4ms"></i> &nbsp;Add user</button> -->
                        <div class="clearfix"></div>
                    </div>
                    <div class="input-daterange input-group" id="flight-datepicker">
   ...
   <!-- add user modal -->
    ...
    <script type='text/javascript' src="${contextPath}js/jquery.dateFormat.javascript"></script>
    <script>
        new WOW().init();
